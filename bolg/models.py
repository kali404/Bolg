...
class UserPont(AbstractUser):
    nicheng = models.CharField(max_length=20, verbose_name='昵称',default='小小阳同学')
    zhiye = models.CharField(max_length=20, verbose_name='职业', default='coder')
    xianju = models.CharField(max_length=20, verbose_name='现居地')
    img = models.ImageField(verbose_name='用户头像',default='img/bubble.png')
...
class Article(models.Model):
    ...
    article_user = models.ForeignKey(UserPont, verbose_name='作者',default=1)
    ...
    pingl = models.IntegerField(verbose_name='评论量', default=0)
...
class Comment(models.Model):
    """文章评论"""
    article_id = models.ForeignKey(Article, verbose_name='文章id')
    text = models.TextField(verbose_name='评论正文', max_length=256)
    create_time = models.DateTimeField(verbose_name='创建时间', auto_now_add=True)
    user_id = models.ForeignKey(UserPont, verbose_name='用户',default=1)
    parent_id = models.ForeignKey('self', verbose_name='上级评论',null=True,blank=True)
